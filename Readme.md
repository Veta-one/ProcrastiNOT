...
![Главный экран](![image](https://github.com/user-attachments/assets/fb7b9d9d-7d74-49d0-9019-ad28902a7cfd))
...
*Режим работы - тёмная тема с жёлтым акцентом*

![Уведомление отдыха](screenshots/rest_notification.png)
*Режим отдыха - светлая тема с красным акцентом*

![Предложение отдохнуть](screenshots/rest_prompt.png)
*Предложение отдохнуть - зелёная тема с кнопками выбора*
...
![Иконки трея](screenshots/tray_icons.png)
...
![Переработка](screenshots/overtime_mode.png)
*Режим переработки с зелёной иконкой*

![Контекстное меню](screenshots/context_menu.png)
*Контекстное меню системного трея*

![Неактивные часы](screenshots/inactive_hours.png)
*Режим сна вне рабочих часов*
